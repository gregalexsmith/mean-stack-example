...
//# sourceMappingURL=/Users/gregsmith/websites/full-apps/mean-stack-example/angular-src/src/environment.prod.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__environments_environment__ = __webpack_require__(334);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__environments_environment__ = __webpack_require__(334);
...
var AuthService = (function () {
    function AuthService(http) {
        this.http = http;
        this.usersUrl = __WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].apiBaseUrl + '/users';
    }
    AuthService.prototype.registerUser = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.usersUrl + '/register', user, { headers: headers }).map(function (res) { return res.json(); });
    };
    AuthService.prototype.authenticateUser = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.usersUrl + '/authenticate', user, { headers: headers }).map(function (res) { return res.json(); });
    };
    AuthService.prototype.getProfile = function () {
        ...
        return this.http.get(this.usersUrl + '/profile', { headers: headers }).map(function (res) { return res.json(); });
    };
